...
public class Assets {
	...
	public static void Cargar()
	{
		...
		//-----------------------------------
		ParallaxLayer edifBlanco = new ParallaxLayer(atlas.findRegion("fondoedificioatras"), new Vector2(3, 0), new Vector2(0, 100), new Vector2(-1, 700), 968, 348);
		ParallaxLayer edifNegro = new ParallaxLayer(atlas.findRegion("fondoedificiofrente"), new Vector2(4, 0), new Vector2(0, 0), new Vector2(-3, 700), 1918, 464);
