...
public class WorldGame {
	...
	final float TIME_TO_SPAWN_CERROS = 1.6f;// Tiempo en segundos para que
											// aparezcan los cerros
	float timeToSpawnCERROS;
	...
	final float TIME_TO_SPAWN_PAISAJE = 2.96f;// Tiempo en segundos para que
												// aparezcan el paisaje
	float timeToSpawnPAISAJE;

	final float TIME_TO_SPAWN_POSTE = 1.6f;// Tiempo en segundos para que
											// aparezcan el poste
	float timeToSpawnPOSTE;

	final float TIME_TO_SPAWN_REJILLAS = .8f;// Tiempo en segundos para que
	...
	final float TIME_TO_SPAWN_BOOS = 1f;// Tiempo en segundos para que aparezcan
										// las rejillas
	float timeToSpawnBOOS;

	// ----------------------------------
	final float TIME_TO_SPAWN_Esceneario2 = 5f;// Tiempo en segundos para que
												// aparezcan las rejillas
	float timeToSpawnEscenario2;
	...
	public WorldGame() {
		...
		// -----------------------
		/*
		 * crearReji(); crearTuberias(); crearTuberiasLargas(); crearFocos();
		 * crearPasaje();
		 */
		// -----------------------
	}
...
>>>>>>> 1c14b362ec9a1bd0592e301fc2b9b053106da4af
